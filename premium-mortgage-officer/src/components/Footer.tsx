      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-4 gap-8 mb-12">
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-white font-serif text-2xl font-bold mb-4">Nikki Varanakis</h3>
            <p className="mb-4 text-slate-400 max-w-sm">
              Helping families in Utah achieve their homeownership dreams with integrity, transparency, and expertise.
            </p>
        ...
        <div className="border-t border-slate-800 pt-8 text-sm text-center md:text-left flex flex-col md:flex-row justify-between items-center">
          <p>&copy; {new Date().getFullYear()} Nikki Varanakis | Intercap Lending. All rights reserved.</p>
        ...
        <div className="mt-8 text-xs text-slate-600 text-center max-w-4xl mx-auto">
          <p>
            This is not a commitment to lend. All loans are subject to credit approval and property appraisal. Rates and programs are subject to change without notice. Intercap Lending is an Equal Housing Lender.
          </p>
        </div>
      </div>
    </footer>
