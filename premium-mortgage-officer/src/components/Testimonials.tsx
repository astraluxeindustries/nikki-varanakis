...
export const Testimonials = () => {
  const reviews = [
    {
      text: "Nikki made the impossible possible. We had a complicated income situation, but she navigated it with ease. We are now in our dream home thanks to her!",
      author: "Michael & Jessica T.",
      type: "First-Time Buyers"
    },
    {
      text: "As a real estate investor, I need speed and reliability. Nikki delivers both every single time. Her knowledge of the market is unmatched.",
      author: "David R.",
      type: "Real Estate Investor"
    },
    {
      text: "The communication was outstanding. I never had to guess where we were in the process. Highly recommend Nikki to anyone looking for a stress-free mortgage.",
      author: "Amanda L.",
