            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <a href="mailto:vgroup@intercaplending.com" className="text-lg font-semibold text-slate-900 hover:text-blue-700 transition-colors">
                    vgroup@intercaplending.com
                  </a>
                </div>
              </div>
